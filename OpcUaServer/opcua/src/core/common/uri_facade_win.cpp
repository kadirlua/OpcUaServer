...
void Uri::Initialize(const std::string& uriString/*const char * uriString, std::size_t size*/)
{
  ...
  if (!InternetCrackUrlA(uriString.c_str(), strlen(uriString.c_str())/*size*/, options, &url))
    {
